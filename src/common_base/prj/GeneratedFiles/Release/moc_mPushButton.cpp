...
#include "../../../mCtrl/pushButton/mPushButton.h"
...
static const char qt_meta_stringdata_MPushButton[] = {
    "MPushButton\0\0splash()\0finishSplash()\0"
};
...
void MPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        MPushButton *_t = static_cast<MPushButton *>(_o);
        switch (_id) {
        case 0: _t->splash(); break;
        case 1: _t->finishSplash(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData MPushButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MPushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_MPushButton,
      qt_meta_data_MPushButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MPushButton::getStaticMetaObject() { return staticMetaObject; }
